            ...
            if ($iteration == 0) {
                ...
                if ($company) {
                    $opportunities[] = [
                        ...
                        'domestic' => $data[15] == 'Yerli' || $data[15] == 'YERLİ' || $data[15] == 'YERLI' ? 0 : 1,
                        ...
                        'foundation_date' => $data[19] ? date_format($data[19], 'Y-m-d') : null,
                        'estimated_result' => $data[20] ?? null,
