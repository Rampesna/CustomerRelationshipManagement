...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="senaryo"
                  select="translate(//n1:Invoice/cbc:ProfileID,'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ')"/>
    <xsl:variable name="hasAnyFalseChangeIndicator">
        <xsl:for-each select="//n1:Invoice/cac:InvoiceLine">
            <xsl:for-each
                select="(cac:AllowanceCharge[translate(cbc:ChargeIndicator,'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ') = 'TRUE']/cbc:Amount)[string(number())!='NaN']">
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <script language="JavaScript1.2">function GetDocumentWidth() {
                    <xsl:choose>
                        <xsl:when test="contains($hasAnyFalseChangeIndicator,'TRUE')">
                            <xsl:if test="not($senaryo = 'IHRACAT' or $senaryo = 'İHRACAT' )">
                                document.getElementById("malHizmet").style.width = "13%";
                                document.getElementById("birimFiyat").style.width = "13%";
                                document.getElementById("digerVergiler").style.width = "14%";
                                document.getElementById("malHizmetTutari").style.width = "11%";
                            </xsl:if>
                            <xsl:if test="$senaryo = 'IHRACAT' or $senaryo = 'İHRACAT'">
                                document.getElementById("malHizmet").style.width = "10%";
                                document.getElementById("miktar").style.width = "6%";
                                document.getElementById("birimFiyat").style.width = "7%";
                                document.getElementById("iskontoOrani").style.width = "6%";
                                document.getElementById("iskontoTutari").style.width = "7%";
                                document.getElementById("malHizmetTutari").style.width = "6%";
                            </xsl:if>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:if test="not($senaryo = 'IHRACAT' or $senaryo = 'İHRACAT' )">
                                document.getElementById("malHizmet").style.width = "17%";
                                document.getElementById("birimFiyat").style.width = "14%";
                                document.getElementById("malHizmetTutari").style.width = "11%";
                            </xsl:if>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <style type="text/css">body { background-color: #FFFFFF; font-family: 'Tahoma', "Times New Roman",
                    Times, serif; font-size: 11px; color: #666666; -webkit-print-color-adjust: exact; } h1, h2 {
                    padding-bottom: 3px; padding-top: 3px; margin-bottom: 5px; text-transform: uppercase; font-family:
                    Arial, Helvetica, sans-serif; } h1 { font-size: 1.4em; text-transform:none; } h2 { font-size: 1em;
                    color: brown; } h3 { font-size: 1em; color: #333333; text-align: justify; margin: 0; padding: 0; }
                    h4 { font-size: 1.1em; font-style: bold; font-family: Arial, Helvetica, sans-serif; color: #000000;
                    margin: 0; padding: 0; } hr { border: 2px solid #000000; } p, ul, ol { margin-top: 1.5em; } ul, ol {
                    margin-left: 3em; } blockquote { margin-left: 3em; margin-right: 3em; font-style: italic; } a {
                    text-decoration: none; color: #70A300; } a:hover { border: none; color: #70A300; }
                    #budgetContainerTable { border-width: 0px; border-spacing: 0px; border-style: inset; border-color:
                    black; border-collapse: collapse; margin-left:auto; } #despatchTable { border-collapse:collapse;
                    float:right; border-color:black; max-width:270px; } #despatchDocumentReferenceTable{
                    border-collapse:collapse; } div.divContainer { width:800px; } #ettnTable { border-collapse:collapse;
                    border-color:black; } #lineTable { border-width:2px; border-style: inset; border-color: black;
                    border-collapse: collapse; } .lineTableTd { border-width: 1px; padding: 1px; border-style: inset;
                    border-color: black; background-color: white; } #lineTableTr { border-width: 1px; padding: 0px;
                    border-style: inset; border-color: black; background-color: white; } #lineTableBudgetTd {
                    border-width: 2px; border-spacing:0px; padding: 1px; border-style: inset; border-color: black;
                    background-color: white; } #notesTable { border-width: 2px; border-style: inset; border-color:
                    black; border-collapse: collapse; } #notesTableTd { border-width: 0px; border-style: inset;
                    border-color: black; border-collapse: collapse; } table { border-spacing:0px; } td {
                    border-color:black; } .fixedTableCss{ table-layout:fixed; overflow-wrap:break-word;
                    word-wrap:break-word; -ms-word-wrap:break-word; } #SGK_Table td{ max-width:400px; white-space:
                    pre-wrap; white-space: -moz-pre-wrap; white-space: -pre-wrap; white-space: -o-pre-wrap; word-wrap:
                    break-word; }
                </style>
            ...
            <body onload="javascript:GetDocumentWidth()" style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <xsl:for-each select="cac:Person">
                                                            <xsl:if
                                                                test="cbc:Title!='' or cbc:FirstName!='' or cbc:MiddleName!='' or cbc:FamilyName!='' or cbc:NameSuffix!=''">
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td align="left">
                                                        <xsl:for-each select="cac:PostalAddress">
                                                            ...
                                                            <xsl:if
                                                                test="cbc:StreetName !='' or cbc:BuildingName !='' or cbc:BuildingNumber !=''">
                                                                <br/>
                                                            </xsl:if>
                                                            ...
                                                            <xsl:if
                                                                test="cbc:CitySubdivisionName!='' and cbc:CityName!=''">
                                                                <xsl:text>/ </xsl:text>
                                                            </xsl:if>
                                            ...
                                            <tr align="left">
                                                <xsl:for-each
                                                    select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party">
                                                    <xsl:if
                                                        test="cac:Contact/cbc:Telephone !='' or cac:Contact/cbc:Telefax !=''">
                                                        <td align="left">
                                ...
                                <td width="50%" align="right" valign="middle">
                                    ...
                                    <h1 align="center">
                                        <span style="font-weight:bold; ">
                                            <img src="http://127.0.0.1:8000/assets/media/logos/bien.png" width="100" />
                                        </span>
                                    </h1>
                            ...
                            <tr style="height:118px; " valign="top">
                                <td width="40%" align="left" valign="bottom">
                                    <table id="customerPartyTable" class="fixedTableCss" align="center" border="0"
                                           height="50%" width="100%">
                                        <tbody>
                                            <hr/>
                                            <tr>
                                ...
                                <td width="40%" align="right" valign="bottom">
                                    <table id="despatchTable" class="fixedTableCss" border="1" height="13"
                                           width="270px">
                                        <tbody>
                                            <tr>
                                            ...
                                            <xsl:if test="count(//n1:Invoice/cac:DespatchDocumentReference) = 1">
                                                ...
                                                <xsl:if
                                                    test="//n1:Invoice/cac:DespatchDocumentReference/cbc:IssueDate !=''">
                                                    <tr style="height:13px; ">
                                                        <td align="left">
                                                            <span style="font-weight:bold;">
                                                        ...
                                                        <td align="left">
                                                            <xsl:for-each
                                                                select="//n1:Invoice/cac:DespatchDocumentReference/cbc:IssueDate">
                                                                <xsl:value-of select="substring(.,9,2)"/>-<xsl:value-of
                                                                select="substring(.,6,2)"/>-<xsl:value-of
                                                                select="substring(.,1,4)"/>
                                                            </xsl:for-each>
                                            ...
                                            <xsl:if
                                                test="not(//n1:Invoice/cbc:DocumentCurrencyCode='TRY' or //n1:Invoice/cbc:DocumentCurrencyCode='TRL')">
                                                <tr style="height:13px; ">
                                                    <td align="left">
                                                        <span style="font-weight:bold;">
                            ...
                            <tr>
                                <td>
                                    <xsl:if
                                        test="//n1:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID='VKN']='7750409379'">
                    ...
                    <table width="800">
                        <tr>
                            ...
                            <td align="right" valign="top">
                                <table id="budgetContainerTable" style="position:relative;" class="fixedTableCss"
                                       width="295px">
                                    <tbody>
                                        <xsl:if test="not($senaryo = 'IHRACAT' or $senaryo = 'İHRACAT')">
                                        ...
                                        <xsl:if test="$senaryo = 'IHRACAT' or $senaryo = 'İHRACAT'">
                                            <tr id="budgetContainerTr" align="right">
                                                ...
                                                <td id="lineTableBudgetTd" align="right" width="85px">
                                                    <span>
                                                        ...
                                                        <xsl:text> </xsl:text>
                                                        <xsl:if
                                                            test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID = 'TRL'">
                                                            <xsl:text>TL</xsl:text>
                                                        </xsl:if>
                                                        <xsl:if
                                                            test="not(//n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount/@currencyID = 'TRL')">
                                                            <xsl:value-of
                                            ...
                                            <xsl:if
                                                test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount)  &gt; 0 ">
                                                <tr id="budgetContainerTr" align="right">
                                                    <td id="lineTableBudgetTd" align="right" width="200px">
                                                        <span style="font-weight:bold; ">
                                                    ...
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span>
                                                            <xsl:for-each
                                                                select="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount">
                                                                <xsl:call-template name="Curr_Type">
                                                                    <xsl:with-param name="valuePath" select="."/>
                                                                    <xsl:with-param name="format"
                                                                                    select="'###.##0,00'"/>
                                            ...
                                            <xsl:if
                                                test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount)  &gt; 0 ">
                                                <tr id="budgetContainerTr" align="right">
                                                    <td id="lineTableBudgetTd" align="right" width="200px">
                                                        <span style="font-weight:bold; ">
                                                    ...
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span>
                                                            <xsl:for-each
                                                                select="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount">
                                                                <xsl:call-template name="Curr_Type">
                                                                    <xsl:with-param name="valuePath" select="."/>
                                                                    <xsl:with-param name="format"
                                                                                    select="'###.##0,00'"/>
                                            ...
                                            <xsl:if
                                                test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount)  &gt; 0 ">
                                                <tr id="budgetContainerTr" align="right">
                                                    <td id="lineTableBudgetTd" align="right" width="200px">
                                                        <span style="font-weight:bold; ">
                                                    ...
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span>
                                                            <xsl:for-each
                                                                select="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount">
                                                                <xsl:call-template name="Curr_Type">
                                                                    <xsl:with-param name="valuePath" select="."/>
                                                                    <xsl:with-param name="format"
                                                                                    select="'###.##0,00'"/>
                                        ...
                                        <xsl:if
                                            test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount !='' and number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount) &gt; 0">
                                            <tr id="budgetContainerTr" align="right">
                                                <td id="lineTableBudgetTd" align="right">
                                                    <span style="font-weight:bold; ">
                                        ...
                                        <xsl:if
                                            ...
                                            <xsl:if test="$senaryo = 'IHRACAT' or $senaryo = 'İHRACAT'">
                                                ...
                                                <xsl:if
                                                    test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount)  &gt; 0 ">
                                                    <xsl:if
                                                        test="not(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount/@currencyID ='TRY' or //n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount/@currencyID ='TRL')">
                                                        <tr align="right">
                                                            <td id="lineTableBudgetTd" align="right">
                                                                <span style="font-weight:bold; ">
                                                            ...
                                                            <td id="lineTableBudgetTd" align="right">
                                                                <span>
                                                                    <xsl:value-of
                                                                        select="format-number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:FreeOnBoardValueAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
                                                                    <xsl:text> TL</xsl:text>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                ...
                                                <xsl:if
                                                    test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount)  &gt; 0 ">
                                                    <xsl:if
                                                        test="not(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount/@currencyID ='TRY' or //n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount/@currencyID ='TRL')">
                                                        <tr align="right">
                                                            <td id="lineTableBudgetTd" align="right">
                                                                <span style="font-weight:bold; ">
                                                ...
                                                <xsl:if
                                                    test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount !='' and number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount)  &gt; 0 ">
                                                    <xsl:if
                                                        test="not(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount/@currencyID ='TRY' or //n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount/@currencyID ='TRL')">
                                                        <tr align="right">
                                                            <td id="lineTableBudgetTd" align="right">
                                                                <span style="font-weight:bold; ">
                                            ...
                                            <xsl:if
                                                test="not(//n1:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount/@currencyID ='TRL')">
                                                <tr id="budgetContainerTr" align="right">
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span style="font-weight:bold; ">
                                            ...
                                            <xsl:if
                                                test="not(//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount/@currencyID ='TRL')">
                                                <xsl:if
                                                    test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount !='' and number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount) &gt; 0">
                                                    <tr id="budgetContainerTr" align="right">
                                                        <td id="lineTableBudgetTd" align="right">
                                            ...
                                            <xsl:for-each select="//n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
                                                <xsl:if
                                                    test="not(cbc:TaxAmount/@currencyID = 'TRY' or cbc:TaxAmount/@currencyID = 'TRL')">
                                                    <tr align="right">
                                                        <td id="lineTableBudgetTd" align="right">
                                                            <span style="font-weight:bold; ">
                                                                <xsl:text>Hesaplanan </xsl:text>
                                            ...
                                            <xsl:for-each select="//n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal">
                                                <xsl:if
                                                    test="not(cbc:TaxAmount/@currencyID = 'TRY' or cbc:TaxAmount/@currencyID = 'TRL') and cbc:TaxAmount != ''">
                                                    <tr id="budgetContainerTr" align="right">
                                                        <td id="lineTableBudgetTd" align="right">
                                                            <span style="font-weight:bold; ">
                                                                <xsl:text>KDV Tevkifat-[</xsl:text>
                                            ...
                                            <xsl:if
                                                test="not(//n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount/@currencyID ='TRL')">
                                                <tr id="budgetContainerTr" align="right">
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span style="font-weight:bold; ">
                                            ...
                                            <xsl:if
                                                test="not(//n1:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID ='TRY' or //n1:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount/@currencyID ='TRL')">
                                                <tr align="right">
                                                    <td id="lineTableBudgetTd" align="right">
                                                        <span style="font-weight:bold; ">
                ...
                <br/>
                <xsl:if
                    test="//n1:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentType[translate(text(),'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ')='FATURA']">
                        ...
                        <tbody>
                            <tr id="lineTableTr" align="left">
                                <td class="lineTableTd">
                                    <span style="font-weight:bold; " align="center">&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;Fatura
                                        No
                                    </span>
                                </td>
                                <td class="lineTableTd">
                            ...
                            <xsl:for-each
                                select="//n1:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentType[translate(text(),'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ')='FATURA']">
                                <tr id="lineTableTr" align="left">
                                    <td class="lineTableTd">&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
                                        <xsl:value-of select="../cbc:ID"/>
                                    </td>
                            ...
                            <td style="padding: 4px 5px; border: 2px solid black;">
                                <xsl:for-each select="//n1:Invoice/cac:DespatchDocumentReference">
                                    <xsl:if test="cbc:ID !='' and cbc:IssueDate !=''">
                                        <xsl:value-of select="cbc:ID"/>
                                        <xsl:text>&#xA0;&#xA0;(</xsl:text>
                                        <xsl:value-of select="substring(cbc:IssueDate,9,2)"/>-<xsl:value-of
                                        select="substring(cbc:IssueDate,6,2)"/>-<xsl:value-of
                                        select="substring(cbc:IssueDate,1,4)"/>
                                        <xsl:text>)</xsl:text>
                ...
                <table id="notesTable" class="fixedTableCss" width="800" height="100">
                    <tbody>
                        <tr align="left">
                            <td id="notesTableTd">
                                <xsl:if
                                    test="not($senaryo = 'IHRACAT' or $senaryo = 'İHRACAT' or $senaryo = 'YOLCUBERABERFATURA' or $senaryo = 'YOLCUBERABER')">
                                    <xsl:choose>
                                        <xsl:when test="//n1:Invoice/cbc:InvoiceTypeCode = 'IHRACKAYITLI'">
                                            ...
                                            <xsl:if
                                                test="count(//n1:Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[./cbc:TaxExemptionReasonCode='701'])>0">
                                                3065 sayılı KDV Kanunu'nun 11/1-c maddesi hükümlerine göre ihraç edilmek
                                                şartıyla teslim edildiğinden KDV tahsil edilmemiştir.
                                                <br/>
                                            </xsl:if>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:for-each select="//n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
                                                <xsl:if
                                                    test="cbc:TaxAmount=0 and cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015' and cac:TaxCategory/cbc:TaxExemptionReason != ''">
                                                    <b>Vergi İstisna Muafiyet Sebebi:&#xA0;</b>
                                                    <xsl:value-of select="cac:TaxCategory/cbc:TaxExemptionReason"/>
                                                    <br/>
                                                </xsl:if>
                                ...
                                <xsl:if
                                    test="$senaryo = 'IHRACAT' or $senaryo = 'İHRACAT' or $senaryo = 'YOLCUBERABERFATURA' or $senaryo = 'YOLCUBERABER'">
                                    <xsl:for-each select="//n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
                                        <xsl:if
                                            test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='0015' and cac:TaxCategory/cbc:TaxExemptionReason != ''">
                                            <b>Vergi İstisna Muafiyet Sebebi:&#xA0;</b>
    ...
    <xsl:template match="dateFormatter">
        <xsl:value-of select="substring(.,9,2)"/>-<xsl:value-of select="substring(.,6,2)"/>-<xsl:value-of
        select="substring(.,1,4)"/>
    </xsl:template>
    <xsl:template match="//n1:Invoice/cac:InvoiceLine">
        <tr id="lineTableTr">
            ...
            <td class="lineTableTd" align="right">
                <xsl:text> </xsl:text>
                <xsl:for-each
                    select="(./cac:AllowanceCharge[translate(cbc:ChargeIndicator,'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ') = 'FALSE']/cbc:MultiplierFactorNumeric)[string(number())!='NaN']">
                    <xsl:text> %</xsl:text>
            ...
            <td class="lineTableTd" align="right">
                <xsl:text> </xsl:text>
                <xsl:for-each
                    select="(cac:AllowanceCharge[translate(cbc:ChargeIndicator,'abcçdefgğhıijklmnoöpqrsştuüvwxyz','ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ') = 'FALSE']/cbc:Amount)[string(number())!='NaN']">
                    <xsl:call-template name="Curr_Type">
                        <xsl:with-param name="valuePath" select="."/>
                        <xsl:with-param name="format" select="'###.##0,00'"/>
                    </xsl:call-template>
