    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ request()->segment(1) === 'erpMatch' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('erpMatch.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
                        ...
                        <span class="menu-text">Ticari Program Eşleşmeleri</span>
                    </a>
                </li>
                @endAuthority

                <li class="menu-section">
                    <h4 class="menu-text">DESTEK</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li class="menu-item {{ request()->segment(1) === 'ticket' ? 'menu-item-active' : null }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ request()->segment(1) === 'video' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('video.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Yardımcı Videolar</span>
                    </a>
                </li>
