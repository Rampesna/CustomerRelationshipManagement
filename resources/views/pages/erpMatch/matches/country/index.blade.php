...
@section('title', 'Ülke Eşleşmeleri')
@php(setlocale(LC_ALL, 'tr_TR.UTF-8'))

@section('content')

    @include('pages.erpMatch.matches.country.modals.delete')
...
@section('page-styles')
    @include('pages.erpMatch.matches.country.components.style')
@stop

@section('page-script')
    @include('pages.erpMatch.matches.country.components.script')
@stop
