...
@section('title', 'Şehir Eşleşmeleri')
@php(setlocale(LC_ALL, 'tr_TR.UTF-8'))

@section('content')

    @include('pages.erpMatch.matches.province.modals.delete')
...
@section('page-styles')
    @include('pages.erpMatch.matches.province.components.style')
@stop

@section('page-script')
    @include('pages.erpMatch.matches.province.components.script')
@stop
