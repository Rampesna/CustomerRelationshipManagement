    ...
    <div class="modal-dialog" role="document" style="max-width:900px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id="RedirectButton">Evet</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="RejectRedirectButton">Hayır</button>
            </div>
        </div>
    </div>
</div>
