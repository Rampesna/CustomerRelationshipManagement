...
@section('title', $opportunity->name . ' - Numuneler')
...
@section('content')
    ...
    @include('pages.opportunity.show.sample.components.create')
...
@section('page-styles')
    @include('pages.opportunity.show.sample.components.style')
@stop

@section('page-script')
    @include('pages.opportunity.show.sample.components.script')
@stop
