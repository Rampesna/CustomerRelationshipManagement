...
@section('content')
    ...
    @include('pages.manager.components.create')
    @include('pages.manager.components.edit')

    @include('pages.manager.modals.delete')
...
@section('page-styles')
    @include('pages.manager.components.style')
@stop

@section('page-script')
    @include('pages.manager.components.script')
@stop
