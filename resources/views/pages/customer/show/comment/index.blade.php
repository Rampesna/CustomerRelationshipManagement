...
@section('title', $customer->title . ' - Müşteri Yorumları')
...
@section('content')
    ...
    @include('pages.customer.show.comment.components.create')
    @include('pages.customer.show.comment.components.edit')
...
@section('page-styles')
    @include('pages.customer.show.comment.components.style')
@stop

@section('page-script')
    @include('pages.customer.show.comment.components.script')
@stop
