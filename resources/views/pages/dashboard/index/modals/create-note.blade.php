        ...
        <div class="modal-content">
            ...
            <form id="CreateNoteForm" class="modal-body">
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="create_note_company_id">Firma</label>
                            <select id="create_note_company_id" class="form-control">
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="create_note_global">Görüntülenme Türü</label>
                            <select id="create_note_global" class="form-control">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label for="create_note_description">Not İçeriği</label>
                            <textarea id="create_note_description" class="form-control" rows="4"></textarea>
                        </div>
                    </div>
                </div>
            </form>
