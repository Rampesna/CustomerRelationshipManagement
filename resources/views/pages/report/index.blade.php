...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-2 col-6">
            <a href="{{ route('report.show', ['report' => 'target']) }}" class="card card-custom card-stretch gutter-b">
                <div class="card-body">
                    <span class="svg-icon svg-icon-dark-75 svg-icon-3x ml-n1">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Hedef Raporu</div>
                </div>
            </a>
        </div>
