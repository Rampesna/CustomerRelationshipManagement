<div id="EditRightbar" style="width: 900px; max-width: 90%" class="offcanvas offcanvas-right p-10">
                ...
                <div class="row mt-6">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label for="name_edit">Video Başlığı</label>
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <input id="url_edit" type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
