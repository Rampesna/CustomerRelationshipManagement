...
@section('content')
    ...
    @include('mobile.activity.modals.create')
    @include('mobile.activity.modals.edit')
...
@section('page-styles')
    @include('mobile.activity.components.style')
@stop

@section('page-script')
    @include('mobile.activity.components.script')
@stop
