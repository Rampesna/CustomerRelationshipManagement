...
@section('content')
    ...
    @include('mobile.opportunity.show.sample.modals.create')
    @include('mobile.opportunity.show.sample.modals.edit')

    @include('mobile.opportunity.show.sample.modals.create-sample-item')
...
@section('page-styles')
    @include('mobile.opportunity.show.sample.components.style')
@stop

@section('page-script')
    @include('mobile.opportunity.show.sample.components.script')
@stop
